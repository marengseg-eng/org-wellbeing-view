...
export const FACTOR_RECOMMENDATIONS: Record<FactorKey, string[]> = {
  ...
  assedio_moral: [
    "Implementar Política de Prevenção e Combate ao Assédio Moral conforme Lei 14.457/2022 e NR-01.",
    "Criar e divulgar canal de denúncia anônimo, seguro e acessível a todos os trabalhadores.",
    "Realizar treinamentos obrigatórios e periódicos sobre assédio moral para todos os níveis hierárquicos.",
    "Instituir Comitê de Ética e Conduta para apuração e acompanhamento de denúncias.",
    "Estabelecer política de tolerância zero ao assédio moral com medidas disciplinares claras.",
    "Promover campanhas de conscientização sobre respeito, dignidade e saúde mental no trabalho.",
    "Garantir acolhimento e suporte psicológico às vítimas de assédio moral.",
    "Monitorar indicadores de clima organizacional relacionados ao assédio.",
  ],
  assedio_verbal: [
    "Elaborar e divulgar Código de Conduta com diretrizes claras sobre comunicação respeitosa.",
    "Realizar treinamentos em Comunicação Não Violenta (CNV) para lideranças e equipes.",
    "Criar canal de denúncia para relatos de assédio verbal, garantindo anonimato e proteção ao denunciante.",
    "Implementar mediação de conflitos por profissionais capacitados.",
    "Promover campanhas educativas sobre o impacto do assédio verbal na saúde mental dos trabalhadores.",
    "Estabelecer medidas disciplinares progressivas para condutas de assédio verbal.",
    "Monitorar e documentar ocorrências para identificar padrões e áreas de maior incidência.",
  ],
  assedio_sexual: [
    "Implementar Programa de Prevenção e Combate ao Assédio Sexual conforme Lei 14.457/2022.",
    "Criar canal de denúncia seguro, anônimo e com protocolo específico para casos de assédio sexual.",
    "Realizar treinamentos obrigatórios (mínimo anual) sobre prevenção ao assédio sexual — Lei 14.457/2022, Art. 23.",
    "Incluir regras de conduta sobre assédio sexual nas normas internas da empresa.",
    "Garantir acolhimento imediato, suporte psicológico e jurídico às vítimas.",
    "Adotar medidas disciplinares rigorosas e imediatas contra agressores comprovados.",
    "Fixar procedimentos para recebimento e acompanhamento de denúncias com sigilo absoluto.",
    "Promover campanhas de conscientização com foco em consentimento e respeito no ambiente de trabalho.",
  ],
  assedio_fisico: [
    "Realizar mapeamento de riscos de violência física nos ambientes de trabalho.",
    "Implementar controle de acesso e medidas de segurança patrimonial nas áreas de risco.",
    "Criar protocolo de resposta a incidentes de violência física com fluxo de atendimento imediato.",
    "Realizar treinamentos em técnicas de desescalada e prevenção de conflitos físicos.",
    "Garantir suporte médico, psicológico e jurídico imediato às vítimas de violência.",
    "Estabelecer canal de denúncia específico para situações de violência e assédio físico.",
    "Adotar medidas disciplinares rigorosas e afastamento imediato do agressor.",
    "Promover cultura de paz e respeito mútuo no ambiente organizacional.",
    "Documentar e investigar todos os incidentes para prevenção de reincidência.",
  ],
};
